...
public class Van extends Veiculo {
    ...
    public Van(String placa, double capacidadeCarga, String tipoCombustivel, String chassi, String marca, int kmRodados, ArrayList<Manutencao> manutencao) {
    ...
    public void calcularCustos() {
        System.out.println(String.format("O custo total da Van é de: %d", multiGasto * super.getKmRodados()));
    }
}
